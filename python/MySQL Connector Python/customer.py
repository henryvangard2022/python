...
#                                                                         #
# DELETE statment completed and tested successfully both by name and ID   #
#                                                                         #
# Project is complete.                                                    #
#                                                                         #
...
def SearchCustomer():
    ...
    if int(choice) == 10:  # return to main menu
        ...
        pass                # ooops didn't get to this (might remove it)
...
# If you're running this app instead of calling from another module
